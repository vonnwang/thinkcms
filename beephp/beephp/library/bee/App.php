...
use bee\exception\ClassNotFoundException;
use bee\exception\HttpException;
use bee\exception\HttpResponseException;
use bee\exception\RouteNotFoundException;
...
class App
{
    ...
    public static function run(Request $request = null)
    {
        ...
        try {
            ...
            // 加载系统语言包
            Lang::load([
                BEE_PATH . 'lang' . DS . $request->langset() . EXT,
    ...
    private static function init($module = '')
    {
        ...
        if (is_file(APP_PATH . $module . 'init' . EXT)) {
            ...
            //加载公共模块配置
            $commonConfigFile = APP_PATH . 'common/config/config'. CONF_EXT;
     ...
     * URL路由检测（根据PATH_INFO)
     * @access public
     * @param  \bee\Request $request 请求实例
     * @param  array          $config  配置信息
     * @return array
