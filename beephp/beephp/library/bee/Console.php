...
use bee\console\command\Help as HelpCommand;
...
use bee\console\output\driver\Buffer;
...
class Console
{
    ...
    private static $defaultCommands = [
        "bee\\console\\command\\Help",
        "bee\\console\\command\\Lists",
        "bee\\console\\command\\Build",
        "bee\\console\\command\\Clear",
        "bee\\console\\command\\make\\Controller",
        "bee\\console\\command\\make\\Model",
        "bee\\console\\command\\optimize\\Autoload",
        "bee\\console\\command\\optimize\\Config",
        "bee\\console\\command\\optimize\\Route",
        "bee\\console\\command\\optimize\\Schema",
    ];
            ...
            if (is_file(CONF_PATH . 'command' . EXT)) {
                ...
                if (is_array($commands)) {
                    foreach ($commands as $command) {
                        ...
                        is_subclass_of($command, "\\bee\\console\\Command") &&
    ...
    protected function getDefaultCommands()
    {
        ...
        foreach (self::$defaultCommands as $class) {
            if (class_exists($class) && is_subclass_of($class, "bee\\console\\Command")) {
