...
class Debug
{
    ...
    {
        return number_format((microtime(true) - BEE_START_TIME), $dec);
    }
    ...
    {
        $size = memory_get_usage() - BEE_START_MEM;
        $a    = ['B', 'KB', 'MB', 'GB', 'TB'];
        $pos  = 0;
    ...
    public static function inject(Response $response, &$content)
    {
        ...
        $class  = false !== strpos($type, '\\') ? $type : '\\bee\\debug\\' . ucwords($type);
        ...
        /** @var \bee\debug\Console|\bee\debug\Html $trace */
