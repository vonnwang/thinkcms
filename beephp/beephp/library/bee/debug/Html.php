...
class Html
{
    ...
    {
        $this->config['trace_file'] = BEE_PATH . 'tpl/page_trace.tpl';
    ...
    public function output(Response $response, array $log = [])
    {
        ...
        // 获取基本信息
        $runtime = number_format(microtime(true) - BEE_START_TIME, 10, '.', '');
        $reqs    = $runtime > 0 ? number_format(1 / $runtime, 2) : '∞';
        $mem     = number_format((memory_get_usage() - BEE_START_MEM) / 1024, 2);
