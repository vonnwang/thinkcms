...
use bee\db\Query;
use bee\exception\ValidateException;
use bee\model\Collection as ModelCollection;
use bee\model\Relation;
use bee\model\relation\BelongsTo;
use bee\model\relation\BelongsToMany;
use bee\model\relation\HasMany;
use bee\model\relation\HasManyThrough;
use bee\model\relation\HasOne;
use bee\model\relation\MorphMany;
use bee\model\relation\MorphOne;
use bee\model\relation\MorphTo;
...
abstract class Model implements \JsonSerializable, \ArrayAccess
{
     ...
     * 转换当前模型数据集为数据集对象
     * @access public
     * @param array|\bee\Collection $collection 数据集
