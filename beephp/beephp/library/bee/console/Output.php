...
use Exception;
use bee\console\output\Ask;
use bee\console\output\Descriptor;
use bee\console\output\driver\Buffer;
use bee\console\output\driver\Console;
use bee\console\output\driver\Nothing;
use bee\console\output\Question;
use bee\console\output\question\Choice;
use bee\console\output\question\Confirmation;

/**
 * Class Output
 * @package bee\console
 *
 * @see     \bee\console\output\driver\Console::setDecorated
 * @method void setDecorated($decorated)
 *
 * @see     \bee\console\output\driver\Buffer::fetch
 * @method string fetch()
 *
...
class Output
{
    ...
    {
        $class = '\\bee\\console\\output\\driver\\' . ucwords($driver);
