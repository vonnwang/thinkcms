...
namespace bee\console\output\descriptor;

use bee\Console as BeeConsole;
...
class Console
{
    ...
    /**
     * 构造方法
     * @param BeeConsole $console
     * @param string|null  $namespace
     */
    public function __construct(BeeConsole $console, $namespace = null)
    {
